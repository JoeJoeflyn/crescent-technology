  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-2">
      ...
      <WorldMap
        dots={[
          {
            start: { lat: 24.7136, lng: 46.6753 }, // Riyadh, KSA
            end: { lat: 24.5247, lng: 39.5692 }, // Madinah, KSA
          },
          {
            start: { lat: 24.7136, lng: 46.6753 }, // Riyadh, KSA
            end: { lat: 17.385, lng: 78.4867 }, // Hyderabad, India
          },
          {
          ...
          },
          {
            ...
            end: { lat: 33.749, lng: -84.388 }, // Atlanta, GA, USA
          },
          {
            start: { lat: 24.5247, lng: 39.5692 }, // Madinah, KSA
            end: { lat: 33.749, lng: -84.388 }, // Atlanta, GA, USA
          },
        ]}
      />
